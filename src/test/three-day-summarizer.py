...
class Scheduler:
    ...
    def post_period(self, url, default_payload):
...
scheduler.generate_job_periods(start_date, end_date)

next_past_job = scheduler.get_next_past_job()
